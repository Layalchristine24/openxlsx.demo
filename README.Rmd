...
You can find an explanation about how the `openxlsx` functions are used in the `openxlsx.demo` 
package in my blog post [`Working with {openxlsx}`](https://layalchristinelettry.rbind.io/blog/202303_openxlsx/).

## `openxlsx` Documentation

You can find a description of the `openxlsx` functions by clicking on the following
links: 
