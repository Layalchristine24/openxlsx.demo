...
royalty_free_image <- image_read(
  system.file(
    "logo",
    "excel-gd340e82a6_1280.png",
    package = "openxlsx.demo"
  )
)

# set the package name
package_name <- "openxslx.demo"

# set the package url
url_package <- "https://github.com/Layalchristine24/openxlsx.demo"
...
sticker(
  ...
  p_size = 3.5, #                * package name font size
  h_size = 1.2, #                * hexSticker size
  h_fill = "#d9ead3", #          * hexSticker background color
